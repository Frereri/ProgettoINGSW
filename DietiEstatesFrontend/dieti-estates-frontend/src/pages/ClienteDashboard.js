...
const ClienteDashboard = () => {
    ...
    const [view, setView] = useState('offerte'); // 'offerte', 'password'
                ...
                {view === 'password' && (
                    <div style={formCardStyle}>
                        ...
                        <form onSubmit={handleChangePassword} style={{display: 'flex', flexDirection: 'column', gap: '15px'}}>
                            <input type="password" placeholder="Password Attuale" style={inputStyle} value={pwData.oldPw} onChange={e => setPwData({...pwData, oldPw: e.target.value})} required />
                            <input type="password" placeholder="Nuova Password" style={inputStyle} value={pwData.newPw} onChange={e => setPwData({...pwData, newPw: e.target.value})} required />
