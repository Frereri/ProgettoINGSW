...
public class VisualizzaImmobileDTO {
    ...
    public VisualizzaImmobileDTO(String titolo, String indirizzo, String immagine, String descrizione, 
                                 Integer dimensioni, double prezzo, String piano, Integer numeroStanze, 
                                 String classeEnergetica, boolean ascensore, boolean portineria, 
                                 boolean climatizzazione, boolean boxAuto, boolean terrazzo, 
                                 boolean giardino, String tipoAnnuncio) {
        this.titolo = titolo;
