...
public abstract class Immobile {
    ...
    @OneToMany(mappedBy = "immobile", cascade = CascadeType.ALL, fetch = FetchType.LAZY, orphanRemoval = true)
    private List<ImmobileImmagine> immagini;

	protected Immobile() {
		
	}

	protected Immobile(Integer idImmobile, String titolo, String citta, String provincia, String indirizzo, double prezzo,
			...
			boolean vicinoParchi, boolean vicinoTrasporti, Agenzia agenzia, Agente agente, List<Offerta> offerte, List<ImmobileImmagine> immobileImmagine) {
		super();
		...
		this.immagini = immobileImmagine;	}
	...
	public List<ImmobileImmagine> getImmagini() {
		return immagini;
	}

	public void setImmagini(List<ImmobileImmagine> immagini) {
