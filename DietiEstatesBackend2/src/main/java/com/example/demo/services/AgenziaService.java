...
public class AgenziaService {
    ...
    private final IAgenziaMapper agenziaMapper;
    
    private static final String AGENZIA_NOT_FOUND = "Agenzia non trovata";

    public AgenziaService(AgenziaRepo agenziaRepo, IAgenziaMapper agenziaMapper) {
    ...
    public AgenziaDTO findById(Integer id) {
        Agenzia agenzia = agenziaRepo.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, AGENZIA_NOT_FOUND));
