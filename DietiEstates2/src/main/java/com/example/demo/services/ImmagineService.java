...
public class ImmagineService {
    ...
    private final ImmobileImmagineRepo immagineRepo;
    private final ImmobileRepo immobileRepo;
    private final IImmobileImmagineMapper immagineMapper;

    public ImmagineService(ImmobileImmagineRepo immagineRepo, ImmobileRepo immobileRepo,
			IImmobileImmagineMapper immagineMapper) {
