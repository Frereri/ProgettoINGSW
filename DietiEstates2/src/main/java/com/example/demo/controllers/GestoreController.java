...
public class GestoreController {
    ...
    public ResponseEntity<AgenteDTO> registraAgente(
    ...
    public ResponseEntity<Void> eliminaAgente(@PathVariable UUID id) {
    ...
    public ResponseEntity<List<ImmobileDTO>> getImmobiliAgenzia(@AuthenticationPrincipal Jwt jwt) {
